...
const config = {
  ...
  organizationName: 'fasakinhenry', // Usually your GitHub org/user name.
  projectName: 'bash-learning', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Knowbash, Henqsoft. Built with 💖 for the community.`,
      },
      prism: {
